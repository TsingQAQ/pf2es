...
fun = EE6(input_dim=input_dim, exp_id=666).joint_objective_con()
...
np.savetxt('EE6_6D_front.txt', MOOResult(res).fronts)
np.savetxt('EE6_6D_input.txt', MOOResult(res).inputs)
np.savetxt('EE6_6D_constraint.txt', MOOResult(res).constraint)