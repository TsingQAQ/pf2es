...
def run_qPF2ES_q2():
    ...
    main(
        ...
        q=2,
        fp="",
        kw_acq= {"sample_pf_num": 5, "pareto_epsilon": 0.04, 'batch_mc_sample_size': 32, 'parallel_sampling': True},
        kw_bench={"initial_x": "Stored"},
        kw_model = {'likelihood_variances': [0.01, 1E-6]}
    )
