...
def run_PF2ES_epsilon_tight():
    print("Run PF2ES lower bound")
    main(
        cfg="VLMOP2_cfg",
        pb='VLMOP2',
        r=30,
        ...
        q=1,
        fp="",
        kw_acq= {"sample_pf_num": 5, 'pareto_epsilon': 0, 'use_dbscan_for_conservative_epsilon': True},
        kw_bench={"initial_x": "Stored"},
    )
...
def run_qPF2ES_q4():
    ...
    main(
        ...
        q=4,
        fp="",
        kw_acq= {"sample_pf_num": 5, "pareto_epsilon": 0.04, 'batch_mc_sample_size': 32},
        kw_bench={"initial_x": "Stored"},
    )
