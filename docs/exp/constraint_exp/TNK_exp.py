...
def run_qPF2ES_q2():
    ...
    main(
        ...
        q=4,
        fp="",
        kw_acq={"constraint_tag": CONSTRAINT, "parallel_sampling": True, "batch_mc_sample_size": 512},
        kw_bench={"initial_x": "Stored"},
        kw_optimize={"acquire_return_builder": True},
    )
...
def run_qCEHVI_q2():
    ...
    main(
        ...
        q=2,
        fp="",
        kw_acq={"objective_tag": OBJECTIVE, "constraint_tag": CONSTRAINT, "sample_size": 32},
        kw_bench={"initial_x": "Stored"},
    )
