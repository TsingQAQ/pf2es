...
from trieste.objectives.multi_objectives import dtlz1, dtlz2, DTLZ1, DTLZ2
...
class StackedDTLZFunction:
    ...
    def objective(self):
        def stacked_obj(inputs: TensorType) -> TensorType:  # [N, D] -> [N, 2, D]
            obj1 = tf.expand_dims(self._dtlz1_obj(inputs), -2) # [N, 1, M]
            obj2 = tf.expand_dims(self._dtlz2_obj(inputs), -2) # [N, 1, M]
            return tf.concat([obj1, obj2], axis=-2) # [N, 2, M]
        return stacked_obj
